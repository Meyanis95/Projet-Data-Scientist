#--------------------------------------------------------------------------------
#Hello !!
#Tu peux directement exécuter le programme pour voir mes réponses aux questions ! 
#--------------------------------------------------------------------------------
...
def how_many_handle(data)
    puts data.length
end 

def short_handle(data)
    min = []
    data.each do |i|
        min.append(i.length)
    end
...
def maj(data)
    maj = []
    data.each do |i|
        if i.slice(1).capitalize == i.slice(1)
            maj.append(i)
        end 
    end 
    puts maj.length
...
def sort_size(data)
    puts data.sort_by {|element| element.length}
end
...
def perform(data)
    data = data
    puts "Hello, bienvenue son mon programme !"
    puts "Pour passer à la première question, tape entrer"
    gets.chomp
    puts "Combien y a-t-il de handle dans cette array ?"
    print "> "
    #Question 1
    how_many_handle(data)
    #Question 1
    puts "Tape entrer pour aller à la question suivante !"
    gets.chomp 
    ...
    repartition(data)
    puts "Merci à toi :) !"
    puts "J'espère que c'était clair !"
end
